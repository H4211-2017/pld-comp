    ...
    : AbstractExpression("AffectationExpression")
{
	...
	switch(op)
	{
		...
		case AFFECT :
			...
			break;
		case AFFECT_MULT :
			this->transformedExpr = std::make_shared<MultExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_DIV :
			this->transformedExpr = std::make_shared<DivExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_ADD :
			this->transformedExpr = std::make_shared<AddExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_SUB :
			this->transformedExpr = std::make_shared<SubExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_MOD :
			this->transformedExpr = std::make_shared<ModuloExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_BIT_AND :
			this->transformedExpr = std::make_shared<BitwiseAndExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_BIT_OR :
			this->transformedExpr = std::make_shared<BitwiseOrExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_BIT_XOR :
			this->transformedExpr = std::make_shared<BitwiseXorExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
		case AFFECT_BIT_LEFT_SHIFT :
			this->transformedExpr = std::make_shared<BitwiseShiftLeftExpression>(std::make_shared<IDExpression>(id, scope), rightMember);
			break;
